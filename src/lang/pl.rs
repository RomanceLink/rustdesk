...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "LaLaDesk może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować LaLaDesk w swoim systemie."),
        ...
        ("Discovered", "Wykryte"),
        ("install_daemon_tip", "By uruchomić LaLaDesk przy starcie systemu, musisz zainstalować usługę systemową."),
        ("Remote ID", "Zdalne ID"),
        ("Paste", "Wklej"),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić LaLaDesk na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [LaLaDesk Input]."),
        ...
        ("Language", "Język"),
        ("Keep LaLaDesk background service", "Zachowaj usługę LaLaDesk w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji LaLaDesk, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji LaLaDesk uprawnień do \"Urządzeń Wejściowych\"."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z LaLaDesk w Twojej sieci."),
        ...
        ("verify_laladesk_password_tip", "Weryfikuj hasło LaLaDesk"),
        ...
        ("scam_text1", "Jeżeli rozmawiasz przez telefon z osobą której NIE ZNASZ i NIE UFASZ, która prosi Cię o uruchomienie programu LaLaDesk - nie rób tego i natychmiast się rozłącz."),
        ...
        ("upgrade_laladesk_server_pro_to_{}_tip", "Proszę zaktualizować LaLaDesk Server Pro do wersji {} lub nowszej!"),
        ...
        ("selinux_tip", "SELinux jest włączony na Twoim urządzeniu, co może przeszkodzić w uruchomieniu LaLaDesk po stronie kontrolowanej."),
        ...
        ("powered_by_me", "Obsługiwane przez LaLaDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Zezwalaj na połączenie tylko wtedy, gdy okno LaLaDesk jest otwarte"),
        ...
        ("floating_window_tip", "Pozwala zachować usługę LaLaDesk w tle"),
        ...
        ("upgrade_remote_laladesk_client_to_{}_tip", "Proszę zaktualizować zdalny klient LaLaDesk do wersji {} lub nowszej!"),
