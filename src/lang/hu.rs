...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Előfordul, hogy bizonyos esetekben hiba léphet fel a Portable verzió használatakor. A megfelelő működés érdekében, telepítse a LaLaDesk alkalmazást a számítógépére."),
        ("Click to upgrade", "Kattintson ide a frissítés telepítéséhez"),
        ("Configure", "Beállítás"),
        ("config_acc", "A számítógép távoli vezérléséhez a LaLaDesknek hozzáférési jogokat kell biztosítania."),
        ("config_screen", "Ahhoz, hogy távolról hozzáférhessen számítógépéhez, meg kell adnia a LaLaDesknek a \"Képernyőfelvétel\" jogosultságot."),
        ...
        ("android_input_permission_tip1", "Ahhoz, hogy egy távoli eszköz vezérelhesse Android készülékét, engedélyeznie kell a LaLaDesk számára a \"Hozzáférhetőség\" szolgáltatás használatát."),
        ("android_input_permission_tip2", "A következő rendszerbeállítások oldalon a letöltött alkalmazások menüponton belül, kapcsolja be a [LaLaDesk Input] szolgáltatást."),
        ...
        ("Language", "Nyelv"),
        ("Keep LaLaDesk background service", "LaLaDesk futtatása a háttérben"),
        ("Ignore Battery Optimizations", "Akkumulátorkímélő figyelmen kívül hagyása"),
        ("android_open_battery_optimizations_tip", "Ha le szeretné tiltani ezt a funkciót, lépjen a LaLaDesk alkalmazás beállításaiba, keresse meg az [Akkumulátorkímélő] lehetőséget és válassza a nincs korlátozás lehetőséget."),
        ...
        ("Show LaLaDesk", "A LaLaDesk megjelenítése"),
        ...
        ("config_input", "Ahhoz, hogy a távoli asztalt a billentyűzettel vezérelhesse, a LaLaDesknek meg kell adnia a \"Bemenet figyelése\" jogosultságot."),
        ("config_microphone", "Ahhoz, hogy távolról beszélhessen, meg kell adnia a LaLaDesknek a \"Hangfelvétel\" jogosultságot."),
        ...
        ("still_click_uac_tip", "A távoli felhasználónak továbbra is az \"Igen\" gombra kell kattintania a LaLaDesk UAC ablakában. Kattintson!"),
        ...
        ("verify_laladesk_password_tip", "LaLaDesk jelszó megerősítése"),
        ...
        ("scam_text1", "Ha olyan valakivel beszél telefonon, akit NEM ISMER, akiben NEM BÍZIK MEG, és aki arra kéri, hogy használja a LaLaDesket és indítsa el a szolgáltatást, ne folytassa, és azonnal tegye le a telefont."),
        ...
        ("upgrade_laladesk_server_pro_to_{}_tip", "Frissítse a LaLaDesk Server Prot a(z) {} vagy újabb verzióra!"),
        ...
        ("selinux_tip", "A SELinux engedélyezve van az eszközén, ami azt okozhatja, hogy a LaLaDesk nem fut megfelelően, mint ellenőrzött webhely."),
        ...
        ("powered_by_me", "Üzemeltető: LaLaDesk"),
        ("outgoing_only_desk_tip", "Ez a LaLaDesk testre szabott kimenete.\nMás eszközökhöz kapcsolódhat, de más eszközök nem kapcsolódhatnak az Ön eszközéhez."),
        ("preset_password_warning", "Ez egy testre szabott kimenet a LaLaDeskből egy előre beállított jelszóval. Bárki, aki ismeri ezt a jelszót, teljes irányítást szerezhet a készülék felett. Ha nem kívánja ezt megtenni, azonnal távolítsa el ezt a szoftvert."),
        ...
        ("allow-only-conn-window-open-tip", "Csak akkor engedélyezze a kapcsolódást, ha a LaLaDesk ablak nyitva van."),
        ...
        ("floating_window_tip", "Segít, ha a LaLaDesk a háttérben fut."),
        ...
        ("About LaLaDesk", "LaLaDesk névjegye"),
        ...
        ("upgrade_remote_laladesk_client_to_{}_tip", "Frissítse a LaLaDesk klienst {} vagy újabb verziójára a távoli oldalon!"),
