...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke LaLaDesk..."),
        ...
        ("install_tip", "Karena UAC, LaLaDesk tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal LaLaDesk ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Agar bisa mengontrol Desktopmu dari jarak jauh, Kamu harus memberikan izin \"Aksesibilitas\" untuk LaLaDesk."),
        ("config_screen", "Agar bisa mengakses Desktopmu dari jarak jauh, kamu harus memberikan izin \"Perekaman Layar\" untuk LaLaDesk."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android Anda melalui mouse atau sentuhan, Anda harus mengizinkan LaLaDesk untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input LaLaDesk]."),
        ...
        ("Language", "Bahasa"),
        ("Keep LaLaDesk background service", "Pertahankan LaLaDesk berjalan pada service background"),
        ...
        ("Show LaLaDesk", "Tampilkan LaLaDesk"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada LaLaDesk"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada LaLaDesk"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC LaLaDesk yang sedang berjalan"),
        ...
        ("verify_laladesk_password_tip", "Verifikasi Kata Sandi LaLaDesk"),
        ...
        ("scam_text1", "Jika anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan LaLaDesk, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_laladesk_server_pro_to_{}_tip", "Silahkan perbarui LaLaDesk Server Pro ke versi {} atau yang lebih baru!"),
        ...
        ("selinux_tip", "pada perangkat anda, SELinux sedang aktif, yang mana itu dapat mencegah LaLaDesk berfungsi dengan baik sebagai sisi yang dikontrol."),
        ...
        ("powered_by_me", "Didukung oleh LaLaDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Koneksi hanya diperbolehkan jika jendela LaLaDesk sedang terbuka."),
        ...
        ("Floating window", ""),
        ("floating_window_tip", "Untuk menjaga layanan/service LaLaDesk agar tetap aktif"),
        ...
        ("About LaLaDesk", "Tentang LaLaDesk"),
        ...
        ("upgrade_remote_laladesk_client_to_{}_tip", "Silahkan perbarui aplikasi LaLaDesk ke versi {} atau yang lebih baru pada komputer yang akan terhubung!"),
