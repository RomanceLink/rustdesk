...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Σύνδεση στο δίκτυο LaLaDesk..."),
        ...
        ("install_tip", "Λόγω UAC, το LaLaDesk ενδέχεται να μην λειτουργεί σωστά σε ορισμένες περιπτώσεις. Για να αποφύγετε το UAC, κάντε κλικ στο κουμπί παρακάτω για να εγκαταστήσετε το LaLaDesk στο σύστημα"),
        ("Click to upgrade", "Αναβάθμιση τώρα"),
        ("Configure", "Διαμόρφωση"),
        ("config_acc", "Για τον απομακρυσμένο έλεγχο του υπολογιστή σας, πρέπει να εκχωρήσετε δικαιώματα πρόσβασης στο LaLaDesk."),
        ("config_screen", "Για να αποκτήσετε απομακρυσμένη πρόσβαση στον υπολογιστή σας, πρέπει να εκχωρήσετε το δικαίωμα LaLaDesk \"Screen Capture\"."),
        ...
        ("android_input_permission_tip1", "Για να μπορεί μία απομακρυσμένη συσκευή να ελέγχει τη συσκευή σας Android, πρέπει να επιτρέψετε στο LaLaDesk να χρησιμοποιεί την υπηρεσία \"Προσβασιμότητα\"."),
        ("android_input_permission_tip2", "Παρακαλώ μεταβείτε στην επόμενη σελίδα ρυθμίσεων συστήματος, βρείτε και πληκτρολογήστε [Εγκατεστημένες υπηρεσίες], ενεργοποιήστε την υπηρεσία [Είσοδος LaLaDesk]."),
        ...
        ("Language", "Γλώσσα"),
        ("Keep LaLaDesk background service", "Εκτέλεση του LaLaDesk στο παρασκήνιο"),
        ...
        ("Show LaLaDesk", "Εμφάνιση LaLaDesk"),
        ...
        ("config_input", "Για να ελέγξετε την απομακρυσμένη επιφάνεια εργασίας με πληκτρολόγιο, πρέπει να εκχωρήσετε δικαιώματα στο LaLaDesk"),
        ...
        ("still_click_uac_tip", "Εξακολουθεί να απαιτεί από τον απομακρυσμένο χρήστη να κάνει κλικ στο OK στο παράθυρο UAC όπου εκτελείται το LaLaDesk."),
        ...
        ("verify_laladesk_password_tip", "Επιβεβαιώστε τον κωδικό του LaLaDesk"),
        ...
        ("scam_text1", "Αν σας καλέσει κάποιος τον οποίο ΔΕΝ γνωρίζεται και ΔΕΝ ΕΜΠΙΣΤΕΥΕΣΤΕ, και σας ζητήσει να ανοίξετε το LaLaDesk, και να του πείτε τα στοιχεία που εμφανίζει, ΜΗΝ συνεχίσετε και κλείστε το τηλέφωνο ΑΜΕΣΩΣ."),
        ...
        ("upgrade_laladesk_server_pro_to_{}_tip", "Παρακαλώ ενημερώστε τον LaLaDesk Server Pro στην έκδοση {} ή νεότερη!"),
        ...
        ("selinux_tip", "Έχετε ενεργοποιημένο το SELinux, το οποίο πιθανόν εμποδίζει την ορθή λειτουργία του LaLaDesk."),
        ...
        ("powered_by_me", "Με την υποστήριξη της LaLaDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Να επιτρέπεται η σύνδεση μόνο εάν το παράθυρο LaLaDesk είναι ανοιχτό"),
        ...
        ("During service is on", "Κατα την εκκίνηση της υπηρεσίας LaLadesk"),
        ...
        ("About LaLaDesk", "Πληροφορίες για το LaLaDesk"),
        ...
        ("upgrade_remote_laladesk_client_to_{}_tip", "Αναβαθμίστε τον πελάτη LaLaDesk στην έκδοση {} ή νεότερη στην απομακρυσμένη πλευρά!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
