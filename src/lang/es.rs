...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red LaLaDesk en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que LaLaDesk no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar LaLaDesk a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a LaLaDesk de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a LaLaDesk de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que LaLaDesk use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [LaLaDesk Input]."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep LaLaDesk background service", "Dejar LaLaDesk como Servicio en 2do plano"),
        ...
        ("Show LaLaDesk", "Mostrar LaLaDesk"),
        ("This PC", "Este PC"),
        ("or", "o"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a LaLaDesk permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a LaLaDesk permisos de \"Grabar Audio\"."),
        ...
        ("verify_laladesk_password_tip", "Verificar la contraseña de LaLaDesk"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses LaLaDesk e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("upgrade_laladesk_server_pro_to_{}_tip", "¡Por favor, actualiza LaLaDesk Server Pro a la versión {} o superior"),
        ...
        ("selinux_tip", "SELinux está activado en tu dispositivo, lo que puede hacer que LaLaDesk no se ejecute correctamente como lado controlado."),
        ...
        ("powered_by_me", "Con tecnología de LaLaDesk"),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de LaLaDesk de fondo"),
        ...
        ("About LaLaDesk", "Acerca de LaLaDesk"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_laladesk_client_to_{}_tip", "Por favor, actualiza el cliente LaLaDesk a la versión {} o superior en el lado remoto"),
