...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete LaLaDesk..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), LaLaDesk potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare LaLaDesk a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a LaLaDesk il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a LaLaDesk il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a LaLaDesk di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [LaLaDesk Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep LaLaDesk background service", "Mantieni il servizio di LaLaDesk in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione LaLaDesk, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show LaLaDesk", "Visualizza LaLaDesk"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a LaLaDesk 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a LaLaDesk."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di LaLaDesk."),
        ...
        ("verify_laladesk_password_tip", "Conferma password LaLaDesk"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare LaLaDesk e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_laladesk_server_pro_to_{}_tip", "Aggiorna LaLaDesk Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di LaLaDesk come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da LaLaDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra LaLaDesk è aperta"),
        ...
        ("floating_window_tip", "Aiuta a mantenere il servizio LaLadesk in background."),
        ...
        ("About LaLaDesk", "Info su LaLaDesk"),
        ...
        ("upgrade_remote_laladesk_client_to_{}_tip", "Aggiorna il client LaLaDesk remoto alla versione {} o successiva!"),
