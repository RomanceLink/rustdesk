...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem LaLaDesk..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, LaLaDesk v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate LaLaDesku dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate LaLaDesku dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno LaLaDesku dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »LaLaDesk Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep LaLaDesk background service", "Ohrani LaLaDeskovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije LaLaDesk, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "LaLaDesk potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "LaLaDesk potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_laladesk_password_tip", "Preveri geslo za LaLaDesk"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite LaLaDesk, prekinite klic in program zaprite."),
        ("scam_text2", "LaLaDesk omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_laladesk_server_pro_to_{}_tip", "Prosimo, nadgradite LaLaDesk Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo LaLaDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno LaLaDeska odprto"),
        ...
        ("floating_window_tip", "Pomaga pri LaLaDesk storitvi v ozadju"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_laladesk_client_to_{}_tip", "Prosimo, nadgradite LaLaDesk odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
