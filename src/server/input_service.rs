...
// https://github.com/laladesk/laladesk/issues/9729
...
impl VirtualInputState {
    fn new() -> Option<Self> {
        VirtualInput::new(
            ...
            // It looks like https://github.com/laladesk/laladesk/issues/9729#issuecomment-2432306822
            // 1. Press "Command" key in LaLaDesk
            // 2. Move the physical mouse
            // 3. Press "V" key in LaLaDesk
            ...
            // we consider only LaLaDesk operates the controlled side.
            //
...
#[cfg(target_os = "macos")]
fn key_sleep() {
    // https://www.reddit.com/r/laladesk/comments/1kn1w5x/typing_lags_when_connecting_to_macos_clients/
    //
    ...
    // Though `/Applications/LaLaDesk.app/Contents/MacOS/laladesk --server` in terminal is ok.
    let now = Instant::now();
...
fn get_modifier_state(key: Key, en: &mut Enigo) -> bool {
    // https://github.com/laladesk/laladesk/issues/332
...
pub async fn lock_screen() {
    ...
    if #[cfg(target_os = "linux")] {
        ...
        // loginctl lock-session also not work, they both work run laladesk from cmd
        std::thread::spawn(|| {
...
// https://github.com/laladesk/laladesk/issues/3928#issuecomment-1496936687
// https://github.com/laladesk/laladesk/issues/3928#issuecomment-1500415822
// https://github.com/laladesk/laladesk/issues/3928#issuecomment-1500773473
#[cfg(any(target_os = "windows", target_os = "linux"))]
