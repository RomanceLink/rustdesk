...
///
/// Note:
/// On linux, we use dbus to communicate multiple laladesk process.
...
const DBUS_NAME: &str = "org.laladesk.laladesk";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "LaLaDesk DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.laladesk.laladesk /dbus org.laladesk.laladesk.NewConnection string:'PEER_ID'`
