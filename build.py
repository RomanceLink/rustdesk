...
def ffi_bindgen_function_refactor():
    # workaround ffigen
    system2(
        'sed -i "s/ffi.NativeFunction<ffi.Bool Function(DartPort/ffi.Uint8 Function(DartPort/g" flutter/lib/generated_bridge.dart')
...
def build_flutter_dmg(version, features):
    ...
    system2('cp -rf ../target/aarch64-apple-darwin/release/service ./build/macos/Build/Products/Release/RustDesk.app/Contents/MacOS/')
    '''
    system2(
