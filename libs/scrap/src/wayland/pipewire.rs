...
impl PipeWireCapturable {
    fn new(
        ...
        // https://github.com/laladesk/laladesk/issues/6116#issuecomment-1817724244
...
"Failed to obtain screen capture. You may need to upgrade the PipeWire library for better compatibility. Please check https://github.com/laladesk/laladesk/issues/8600#issuecomment-2254720954 for more details.".into()
    )))
}
