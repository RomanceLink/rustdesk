...
#define HRESULT_ERR_ELEMENT_NOT_FOUND 0x80070490
    ...
    LPCWCH RD_DRIVER_INF_PATH = L"drivers\\LaLaDeskPrinterDriver\\LaLaDeskPrinterDriver.inf";
    LPCWCH RD_PRINTER_PORT = L"LaLaDesk Printer";
    LPCWCH RD_PRINTER_NAME = L"LaLaDesk Printer";
    LPCWCH RD_PRINTER_DRIVER_NAME = L"LaLaDesk v4 Printer Driver";
    ...
    {
        // If the printer is used after the spooler service is started. E.g., printing a document through LaLaDesk Printer.
