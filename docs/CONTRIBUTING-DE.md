# Beiträge zu LaLaDesk

LaLaDesk begrüßt Beiträge von jedem. Hier sind die Richtlinien, wenn Sie uns
helfen möchten:

## Beiträge

Beiträge zu LaLaDesk oder seinen Abhängigkeiten sollten in Form von Pull
...
- Wenn Ihr Patch nicht begutachtet wird oder Sie eine bestimmte Person zur
  ...
  per [E-Mail](mailto:info@laladesk.com) um eine Begutachtung bitten.
...
LaLaDesk-Mitarbeiter arbeiten häufig im [Discord](https://discord.gg/nDceKgxnkV).
