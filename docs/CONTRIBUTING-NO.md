...
LaLaDesk er åpene for bidrag fra alle. Her er reglene for de som har lyst til å
hjelpe oss:

## Bidrag

Bidrag til LaLaDesk eller deres avhengigheter burde være i form av GitHub pull requests.
...
- Hvis dine endringer ikke blir sett eller hvis du trenger en spesefik person til
  ...
  Dette kann gjøres i en pull request, en kommentar eller via epost på [email](mailto:info@laladesk.com).
...
LaLaDesk bidragere burker [Discord](https://discord.gg/nDceKgxnkV).
