...
LaLaDesk는 모든 분들의 참여를 환영합니다. 저희를 도와주실 생각이 있으시다면 
 다음 지침을 따르세요:

## 기여

LaLaDesk 또는 그 종속성에 대한 기여는 GitHub 풀 리퀘스트 형태로 
...
- 패치가 검토되지 않거나 특정인이 검토해야 하는 경우, 풀 리퀘스트나
 ...
 [이메일](mailto:info@laladesk.com)을 통해 검토를 요청할 수 있습니다.
...
LaLaDesk 기여자들은 [Discord](https://discord.gg/nDceKgxnkV)에서 활동하고 있습니다.
