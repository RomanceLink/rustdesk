...
class MainFlutterWindow: NSWindow {
    override func awakeFromNib() {
        ...
        let registrar = flutterViewController.registrar(forPlugin: "LaLaDeskPlugin")
        ...
        FlutterMultiWindowPlugin.setOnWindowCreatedCallback { controller in
            ...
            self.setMethodHandler(registrar: controller.registrar(forPlugin: "LaLaDeskPlugin"))
    ...
    public func setMethodHandler(registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "org.laladesk.laladesk/macos", binaryMessenger: registrar.messenger)
