...
List<TTextMenu> toolbarControls(BuildContext context, String id, FFI ffi) {
  ...
  // https://github.com/laladesk/laladesk/pull/9731
...
bool showVirtualDisplayMenu(FFI ffi) {
  ...
  if (ffi.ffiModel.pi.isLaLaDeskIdd || ffi.ffiModel.pi.isAmyuniIdd) {
    return true;
  }
  return false;
}
...
List<Widget> getVirtualDisplayMenuChildren(
  ...
  if (pi.isLaLaDeskIdd) {
    final virtualDisplays = ffi.ffiModel.pi.LaLaDeskVirtualDisplays;
