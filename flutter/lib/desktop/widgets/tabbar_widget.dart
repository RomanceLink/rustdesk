...
class _DesktopTabState extends State<DesktopTab>
  ...
  void onWindowClose() async {
    ...
    if (isMainWindow) {
      if (laLaDeskWinManager.getActiveWindows().contains(kMainWindowId)) {
        await laLaDeskWinManager.unregisterActiveWindow(kMainWindowId);
      }
