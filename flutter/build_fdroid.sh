...
#
# Script to build F-Droid release of LaLaDesk
#
# Copyright (C) 2024, The LaLaDesk Authors
...
#
# - versionName from https://github.com/laladesk/laladesk/releases/download/fdroid-version/laladesk-version.txt
# - versionCode from https://github.com/laladesk/laladesk/releases/download/fdroid-version/laladesk-version.txt
...
prebuild)
	...
	# Flutter used to compile main LaLadesk library
	...
	# Install Flutter version for LaLaDesk library build
...
build)
	...
	cp "target/${RUST_TARGET}/release/libliblaladesk.so" \
		"flutter/android/app/src/main/jniLibs/${ANDROID_ABI}/liblaladesk.so"
